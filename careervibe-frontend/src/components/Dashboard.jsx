            ...
            <motion.div key="dashboard"
             ...
             className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 px-4 py-10 text-white">
                <div className="max-w-5xl mx-auto">
                    <motion.div className="bg-white/10 p-8 rounded-3xl shadow-xl backdrop-blur-lg"
                     initial={{ opacity: 0, y: 40 }}
                ...
                <p className="text-lg mb-8 text-white/80">Here's a quick overview of your activity</p>
